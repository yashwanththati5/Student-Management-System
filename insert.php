...
$dbname = "Students";
 ...
 if($roll and $name and $dept)
 {
    ...
    if (mysqli_num_rows($run) > 0) {
        ...
        echo "<div align = 'center'><a href='insert.html' style='text-decoration: none;' id = 'add'>Return To Home</a></div>";
    }
    else{
    ...
    {
        echo "<div align = 'center'><a href='main.html' style='text-decoration: none;' id = 'add'>Return To Home</a></div>";
    }
?>
</body>
</html>